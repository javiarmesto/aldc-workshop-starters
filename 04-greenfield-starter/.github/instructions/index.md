...
## Available Instructions (10 files)
...
### Manifest and Workspace Guardrails

| File | Purpose | Activates When |
|------|---------|----------------|
| [al-app-test-layout.instructions.md](al-app-test-layout.instructions.md) | Prevent nested App/Test project contamination and missing test manifest dependencies | Working with `app.json` or `.code-workspace` files |
